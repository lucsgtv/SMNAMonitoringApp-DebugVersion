...
#    print("Erro ao acessar arquivos remotos, carregando arquivos locais.")
#    catalog_anl = intake.open_catalog('C:/Users/ll7nt/SMNAMonitoringApp/anls/catalog_anl.yml')
#    catalog_bkg = intake.open_catalog('C:/Users/ll7nt/SMNAMonitoringApp/anls/catalog_bkg.yml')
catalog_anl = intake.open_catalog('examples/catalog_anl.yml')
catalog_bkg = intake.open_catalog('examples/catalog_bkg.yml')
